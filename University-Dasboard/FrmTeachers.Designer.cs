namespace University_Dasboard
{
    partial class FrmTeachers
    {
		...
		private void InitializeComponent()
		{
			...
			comboBoxTeachers.Location = new Point(419, 22);
			...
			checkedListBoxDays.Location = new Point(686, 58);
			...
			label10.Location = new Point(686, 22);
			...
			// 
			dateTimePickerStartTime.Location = new Point(419, 58);
			dateTimePickerStartTime.Name = "dateTimePickerStartTime";
			dateTimePickerStartTime.Size = new Size(234, 23);
			dateTimePickerStartTime.TabIndex = 31;
			// 
			// dateTimePickerEndTime
			// 
			dateTimePickerEndTime.Location = new Point(419, 88);
			dateTimePickerEndTime.Name = "dateTimePickerEndTime";
			dateTimePickerEndTime.Size = new Size(234, 23);
