namespace University_Dasboard
{
    partial class FrmTeachers
    {
        ...
        private void InitializeComponent()
        {
			...
			dgvTeacherList.Location = new Point(12, 322);
			dgvTeacherList.Name = "dgvStudentList";
			dgvTeacherList.Size = new Size(820, 319);
			dgvTeacherList.TabIndex = 28;
			dgvTeacherList.CellValueChanged += dgvStudentList_CellValueChanged;
			dgvTeacherList.RowPostPaint += dgvTeachersList_RowPostPaint;
            // 
            // btnDelete
            // 
