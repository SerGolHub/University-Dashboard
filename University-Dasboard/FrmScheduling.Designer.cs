namespace University_Dasboard
{
    partial class FrmScheduling
    {
		...
		private void InitializeComponent()
		{
			...
			btnAdd.Location = new Point(12, 185);
			btnAdd.Name = "btnAdd";
			...
			btnSave.Location = new Point(877, 290);
			...
			comboBoxFaculties.Location = new Point(200, 12);
			...
			comboBoxGroup.Location = new Point(200, 109);
			...
			comboBoxDirection.Location = new Point(200, 45);
			...
			comboBoxDiscipline.Location = new Point(200, 77);
			...
			comboBoxScheduleWeek.Location = new Point(200, 141);
