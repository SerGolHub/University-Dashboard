namespace University_Dasboard
{
    partial class FrmScheduling
    {
		...
		private void InitializeComponent()
		{
			...
			label4.Location = new Point(339, 57);
			label4.Name = "label4";
			...
			btnDelete.Location = new Point(861, 572);
			...
			btnAdd.Location = new Point(853, 213);
			btnAdd.Name = "btnAdd";
			...
			btnReset.Location = new Point(861, 497);
			btnReset.Name = "btnReset";
			btnReset.Size = new Size(104, 53);
			...
			lbDbSaveResult.Location = new Point(663, 107);
			...
			btnSave.Location = new Point(861, 425);
			...
			dgvSchedules.Location = new Point(24, 290);
			dgvSchedules.Name = "dgvSchedules";
			dgvSchedules.Size = new Size(812, 335);
			...
			label5.Location = new Point(339, 134);
			label5.Name = "label5";
			...
			comboBoxFaculties.Location = new Point(339, 80);
			comboBoxFaculties.Name = "comboBoxFaculties";
			comboBoxFaculties.Size = new Size(265, 26);
			...
			comboBoxGroup.Location = new Point(339, 157);
			comboBoxGroup.Name = "comboBoxGroup";
			comboBoxGroup.Size = new Size(265, 26);
			...
			comboBoxDirection.Location = new Point(24, 157);
			...
			comboBoxDiscipline.Location = new Point(24, 80);
			...
			comboBoxScheduleWeek.Location = new Point(29, 236);
